...
const messages = {
  1: { img: "photo1.jpg", text: "Ты делаешь мои дни ярче ❤️" },
  2: { img: "photo2.jpg", text: "Каждый момент с тобой особенный ✨" },
  3: { img: "photo3.jpg", text: "Я улыбаюсь, когда думаю о тебе 😊" },
  4: { img: "photo4.jpg", text: "Ты моё счастье 💖" },
  5: { img: "photo5.jpg", text: "С тобой любой год будет лучшим 🎄" }
};
